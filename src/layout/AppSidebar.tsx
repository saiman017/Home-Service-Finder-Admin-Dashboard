...
import { FiGrid, FiUsers, FiBriefcase, FiTag, FiList, FiShield, FiPieChart, FiPackage, FiKey, FiChevronDown, FiMoreHorizontal } from "react-icons/fi";
...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    path: "/serviceProvider-management",
  },
  {
    name: "Service Category",
    icon: <TableIcon />,
    path: "/serviceCategory-management",
  },
  {
    name: "Service List",
    icon: <FiList size={20} />,
    path: "/serviceList-management",
  },
  {
    name: "Role",
